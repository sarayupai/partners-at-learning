        ...
        <div className='activities-container'>
            ...
            <div className='activities'> 
                <div className='activity-1'>   
                    <h2>Desmos Art</h2>
                        <h3>Overview:</h3>
                        <p>Students use creativty and graphing principles to design an art peice in Desmos</p>
                        <h3>Purpose:</h3> 
                        <p>Combine art, math, and technology to improve graphing skills</p>
                        <h3>Materials:</h3>
                        <p>-An electronic device</p>
                        <p>-<a href="https://www.desmos.com/calculator">Desmos Graphing Calculator</a> (Alternatively, download the Desmos app)</p>
                        <h3>Instructions:</h3>
                        ...
                        <p>5. Reflect: How can we use mathematical principles to create art? How can we use graphical concepts to manipulate equations?</p>
                </div>
                <div className='activity-2'>
                    <h2>Logarithms in the Real World</h2>
                        <h3>Overview:</h3>
                        <p>Students research applications of logarithms in the real world and design, solve, and explain a world problem relating to the topic</p>
                        <h3>Purpose:</h3>
                        ...
                        <p>4. Solve the word problem in two ways: graphically (by marking the solution point and estimating its value) and by hand (by plugging in a value into the equation you wrote)</p>
                        ...
                        <p>11. Reflect: How are logarithms used in the real world? What are the steps to solving a word problem? How did your understanding of logarithmic, exponential, and inverse functions change? 
                        </p>
                </div>
            </div>
        </div>
